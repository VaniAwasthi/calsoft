    ...
    <>
      ...
      <WhyItMatters
        ...
        data={[
          {
            top: 7.4,
            text: "Inconsistent environments between dev, test, and production",
          },
          {
            top: 16.8,
            text: "Heavy reliance on monolithic applications",
          },
          {
            top: 24.3,
            text: "Inefficient CI/CD pipelines without container orchestration",
          },
          {
            top: 32.7,
            text: "Poor observability & debugging in microservice deployments",
          },
          {
            top: 41.6,
      ...
      <RealWorldImpact
        ...
        cardData={[
          {
            title: null,
            desc: "Containerization of monolithic and distributed workloads",
          },
          {
            title: null,
            desc: "Dockerfile standardization and image optimization",
          },
          {
            title: null,
            desc: "Container security hardening (non-root users, image scanning)",
          },
          {
            title: null,
            desc: "CI/CD-integrated image pipelines",
          },
          {
            title: null,
      ...
      <UseCases
        data={[
          ...
          {
            title:
              "Service mesh integration (Istio, Linkerd) for policy and security",
            subTitle: " for policy and security",
            svg: (
              <svg
                width="59"
                height="59"
          ...
          },
          {
            ...
            subTitle: "and failover management",
            svg: (
              <svg
                width="87"
                height="41"
          ...
          {
            title: null,
            subTitle: "GitOps for declarative rollouts and rollbacks",
            svg: (
              <svg
                width="61"
                height="55"
      ...
      <Agility
        data={{
          leftSideContent: {
            ...
            subTitle: "Calsoft customers have seen:",
            description:
          ...
          rightSideContent: [
            {
              title: "60-80%",
              subTitle: "faster time-to-deploy across environments",
            },
            {
              title: "2-3X Faster",
              subTitle:
                "improvement in resource utilization via bin-packing and autoscaling",
            },
            {
              title: "95% Fewer",
              subTitle:
            ...
            },
            {
              title: "Improved",
              subTitle:
                "developer productivity with isolated, reproducible test environments",
            },
          ],
        }}
      ...
      <WhyCalsoft
        ...
        data={{
          ...
          tableContent: [
            {
              name: "End-to-End Containerization Strategy",
              calsoft: "Workload + Platform",
              vendor: "Tool-Only View",
            },
            {
              name: "K8s Multi-Cluster Management",
              calsoft: "Secure & Observable",
              vendor: "Minimal Orchestration",
            },
            {
              name: "DevSecOps Integration",
              calsoft: "GitOps + Policy-as-Code",
              vendor: "Manual & Inconsistent",
            },
            {
              name: "Service Mesh and RBAC Governance",
              calsoft: "Built-in",
              vendor: "Often Skipped",
            },
            {
              name: "Cost-Aware Scaling + Auto-Healing",
              calsoft: "Based on Workload Demand",
              vendor: "Static or Manual",
            },
          ],
        }}
      />
