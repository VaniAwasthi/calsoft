...
import WhyItMatters from "@/app/component/VirtualizationSolutions/WhyItMatters";
...
export default function Page() {
  ...
  return (
    <>
      <HeroSection
        title="Govern Every VM — From Spin-Up to Spin-Down"
        description="Lifecycle governance that tracks, optimizes, and retires virtual assets by cost, compliance, and performance."
        buttonText="Request Governance Audit"
        heroImage={Img}
        navItems={navItems}
      ...
      <RealWorldImpact
        ...
        cardData={[
          {
            title: "20–35% reduction",
            desc: "in VM sprawl and idle resource cost",
          },
          {
            title: "2x faster provisioning",
            desc: "approvals through owner-aware workflows",
          },
          {
            title: "Improved compliance audit",
            desc: "outcomes via tagging and traceability",
          },
          {
            title: "Up to 50% drop",
            desc: "in orphaned resources within 90 days",
          },
          {
            title: "Streamlined end-of-life",
      ...
      <UseCases
        ...
        data={[
          {
            title: "You manage",
            subTitle: "hundreds or thousands of virtual instances",
            svg: (
              <svg
                width="54"
                height="64"
          ...
          {
            title: "Virtual machines span",
            subTitle: "multiple clouds, regions, or BU owners",
            svg: (
              <svg
                width="64"
                height="62"
          ...
          {
            title: "Your teams struggle with",
            subTitle: "tracking ownership or expiryse vs SaaS tools",
            svg: (
              <svg
                width="59"
                height="59"
          ...
          {
            title: "Compliance requires ",
            subTitle: "traceability of every VM lifecycle action",
            svg: (
              <svg
                width="87"
                height="41"
          ...
          {
            title: "You lack real-time insight into",
            subTitle: "utilization or retirement timelines",
            svg: (
              <svg
                width="61"
                height="55"
          ...
          tableContent: [
            {
              ...
              calsoft: "Yes",
              vendor: "Only Provisioning Phase",
            },
            {
              name: "Cost Center + Owner Tagging",
              calsoft: "Enforced at Creation",
              vendor: "Optional / Unused",
            },
            {
              name: "Idle Asset Clean-up Automation",
              calsoft: "Policy-Driven",
              vendor: "Manual Effort",
            },
            {
              name: "Expiry, EOL, and Retention Alerts",
              calsoft: "Built-In Triggers",
              vendor: "No Auto Notification",
            },
            {
              name: "GRC + FinOps Reporting Integration",
              calsoft: "Native + API Support",
      ...
      <FirstStep
        ...
        headerContent={{
          ...
          description:
            "Our onboarding process is practical, phased, and tool-agnostic:",
        }}
        guessworkData={[
          {
            heading: "Discover",
      ...
      />
      <ContactSecDataAi
        lightContent={"Govern lifecycles with clarity and accountability."}
      />
    </>
  );
}
