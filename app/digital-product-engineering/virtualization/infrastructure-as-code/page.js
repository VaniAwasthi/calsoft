    ...
    <>
      ...
      <WhyItMatters
        ...
        data={[
          {
            top: 2.3,
            text: "Slow to provision, error-prone, and hard to scale",
          },
          {
            top: 11.8,
            text: "Inconsistent across environments (dev/test/prod)",
          },
          {
            top: 18,
            text: "Dependent on tribal knowledge and manual approvals",
          },
          {
            top: 27.5,
            text: "Difficult to version, audit, and rollback",
          },
          {
            top: 35.4,
            text: "Vulnerable to misconfiguration and drift",
          },
        ]}
      ...
      <RealWorldImpact 
        ...
        cardData={[
          {
            title: null,
            desc: " GitOps workflows for pull request-based infra rollouts",
          },
          {
            title: null,
            desc: "Approval workflows and change review gates",
          },
          {
            title: null,
            desc: "Terraform Cloud/Enterprise, Atlantis, or Spacelift integrations",
          },
          {
            title: null,
            desc: "Secret injection from Vault, AWS Secrets Manager, or HashiCorp Boundary",
          },
          {
            title: null,
      ...
      <UseCases
        ...
        data={[
          {
            title: null,
            subTitle: "You manage multi-cloud or hybrid cloud infrastructure",
            svg: (
              <svg
                width="54"
                height="64"
          ...
          },
          {
            title: null,
            subTitle:
              "Your infra rollout cycles are slow, error-prone, or inconsistent",
            svg: (
              <svg
                width="64"
                height="62"
          ...
          },
          {
            title: null,
            subTitle:
              "Compliance requires version control, traceability, and audit trails",
            svg: (
              <svg
                width="59"
                height="59"
          ...
          },
          {
            title: null,
            subTitle:
              "You’re moving to GitOps, Platform Engineering, or DevSecOps",
            svg: (
              <svg
                width="87"
                height="41"
          ...
          {
            title: null,
            subTitle: "You’re preparing for self-service infra for developers",
            svg: (
              <svg
                width="61"
                height="55"
        ...
        heading="When you must scale infra with precision"
        description="IaC is critical if:"
        bottomText={{
          ...
          tableContent: [
            {
              ...
              calsoft: "AWS, Azure, GCP, VMware",
              vendor: "Limited Scope",
            },
            {
              name: "CI/CD & GitOps Integration",
              calsoft: " Built-in Workflows",
              vendor: "Manual Pushes",
            },
            {
              name: "Policy-as-Code & Security",
              calsoft: "OPA/Gatekeeper Support",
              vendor: "Often Ignored",
            },
            {
              name: "Modular & Reusable Architecture",
              calsoft: "Yes",
              vendor: "Ad hoc",
            },
            {
              name: "Team Enablement + Runbook Delivery",
              calsoft: "Standardized Onboarding",
              vendor: "Knowledge Silos",
            },
          ],
        }}
      />
