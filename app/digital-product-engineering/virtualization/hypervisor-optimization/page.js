...
export default function Page() {
  ...
  return (
    <>
      <HeroSection
        title="Optimize Your Hypervisor. Maximize Every Core."
        description="Smarter hypervisor use: fewer licenses, faster VMs, broader platform support."
        buttonText="Schedule Health Check"
        heroImage={Img}
        navItems={navItems}
        ...
        data={[
          {
            ...
            subTitle: "causing contention & performance hits",
          },
          {
            top: 12.2,
            title: "Underutilized hypervisors",
            subTitle: "leading to higher hardware and software costs",
          },
          {
            top: 22.3,
            title: "Fragmented VM",
            subTitle: "placement without alignment to usage patterns",
          },
          {
            top: 31.5,
            title: "License sprawl due to unmanaged hypervisor spread",
          },
          {
            top: 39.7,
            title:
              "Lack of workload alignment with underlying compute/storage profiles",
          },
        ]}
        Component={HyperVision}
      />
      <IntelligentPlanning
        heading="Match resources to workload, not guesswork"
        description="Calsoft’s approach focuses on right-sizing and intelligent workload placement for better ROI from your hypervisor stack."
        data={[
          {
            title: null,
            subTitle: "VM density planning per cluster/node",
          },
          {
            title: null,
            subTitle:
              "Memory and CPU optimization (reservation, shares, limits tuning)",
          },
          {
            title: null,
            subTitle: "IOPS-aware storage balancing",
          },
          {
            title: null,
            subTitle:
              "Real-time telemetry-based placement (vMotion, affinity rules, HA policies)",
          },
          {
            title: null,
      ...
      {/* <UseCases
        ...
        data={[
          {
            title: null,
            subTitle: "Identify underused & unlicensed nodes",
            svg: (
              <svg
                width="54"
                height="64"
          ...
          {
            title: null,
            subTitle: "Consolidate VM sprawl onto fewer hosts",
            svg: (
              <svg
                width="64"
                height="62"
          ...
          },
          {
            title: null,
            subTitle:
              "Recommend migration plans to reduce socket/core-based licensing",
            svg: (
              <svg
                width="59"
                height="59"
          ...
          {
            title: null,
            subTitle: "Compare open-source (KVM) or hybrid stack options",
            svg: (
              <svg
                width="87"
                height="41"
          ...
          {
            title: null,
            subTitle: "Validate usage per SKU against contracts",
            svg: (
              <svg
                width="61"
                height="55"
        ...
        heading="Cut hypervisor cost without compromise"
        description="Hypervisor licenses — especially for enterprise VMware — can drive up infra spend if not managed properly. Calsoft helps:"
        bottomText={{
          text: null,
          bText: null,
        }}
      ...
      <Agility
        ...
        data={{
          ...
          rightSideContent: [
            {
              title: "25–45%",
              subTitle: "increase in VM density per node",
            },
            {
              title: "30–40%",
              subTitle: "reduction in license overhead",
            },
            {
              title: "2x",
              subTitle: "improvement in workload performance stability",
            },
            {
              title: "50% fewer",
              subTitle:
                " performance alerts from noisy neighbor or misplacement issues",
            },
            {
              title: "Improved HA/DR",
              subTitle:
                "· behavior through cluster-level balance and failover tuning",
            },
          ],
        }}
          ...
          tableContent: [
            {
              ...
              calsoft: " Real-time and historic",
              vendor: "Manual/Reactive",
            },
            {
              name: "Licensing & Capacity Rightsizing",
              calsoft: " Cost-Aware Recommendations",
              vendor: "Overlooked",
            },
            {
              name: "Application-Aware VM Placement",
              calsoft: " Policy + Runtime Insights",
              vendor: "Generic Templates",
            },
            {
              name: "Platform-Neutral Expertise",
              calsoft: "VMware, KVM, Hyper-V, AHV",
              vendor: "Stack-Limited",
            },
            {
              name: "Optimization + Migration Advisory",
              calsoft: "Combined",
              vendor: "Disjointed Vendors",
            },
          ],
        }}
      />
      <HowToStart
        headerContent={{
          title1: "How to Start",
          description: "From VM chaos to efficient core usage",
        }}
        data={{
          Assess: "Inventory VM, host, cluster usage, telemetry, and licensing",
          Plan: "Define VM-to-host matching, overcommit ratios, and rightsizing needs",
          Migrate:
            "Apply workload-based placement, affinity tuning, and HA policies",
          Optimise:
            "Remove dead weight, balance resources, validate license usage",
          Enable:
            "Provide dashboards, migration paths, and automation guidance",
        }}
      />
      <ContactSecDataAi
        lightContent={
