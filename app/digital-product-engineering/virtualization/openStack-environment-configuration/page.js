...
export default function Page() {
  ...
  return (
    <>
      <HeroSection
        title="Build OpenStack Right — The First Time."
        description="Production-ready, secure, and scalable OpenStack environments — built for performance."
      ...
      <WhyItMatters
        ...
        data={[
          {
            top: 4.7,
            text: "Over-engineered or under-provisioned architecture",
          },
          {
            top: 12,
            text: "Misaligned component selection (e.g., Neutron, Nova, Cinder)",
          },
          {
            top: 21.2,
            text: "Lack of automation in day-2 operations (patching, scaling, recovery)",
          },
          {
            top: 28.8,
            text: "Performance bottlenecks due to storage/network config mismatches",
          },
          {
            top: 37.8,
        ...
        data={[
          {
            title: null,
            subTitle:
              "IaC strategy & architecture tailored to your cloud/virtual platforms",
          },
          {
            title: null,
            subTitle:
              "Terraform modules for AWS, Azure, GCP, VMware, OpenStack",
          },
          {
            title: null,
            subTitle:
              "Ansible playbooks for host configuration, patching, and lifecycle",
          },
          {
            title: null,
            subTitle:
              "CloudFormation & Bicep templates for native stack provisioning",
          },
          {
            title: null,
            subTitle:
      ...
      <RealWorldImpact
        ...
        cardData={[
          {
            title: null,
            desc: " Component selection (Nova, Neutron, Glance, Cinder, Keystone, Horizon, etc.)",
          },
          {
            title: null,
            desc: "Network topology planning (flat, VLAN, VXLAN, BGP-based routing)",
          },
          {
            title: null,
            desc: "Storage backends (Ceph, NFS, LVM, iSCSI)",
          },
          {
            title: null,
            desc: "High availability & control plane redundancy",
          },
          {
            title: null,
        ...
        data={[
          {
            title: null,
            subTitle:
              "IaC-based deployment (Ansible, Terraform, Kolla-ansible, Helm for OpenStack-Helm)",
            svg: (
              <svg
                width="54"
                height="64"
          ...
          {
            title: null,
            subTitle: "Configuration management for live changes",
            svg: (
              <svg
                width="64"
                height="62"
          ...
          {
            title: null,
            subTitle: "Monitoring via Prometheus, Grafana, Collectd, or Zabbix",
            svg: (
              <svg
                width="59"
                height="59"
          ...
          },
          {
            title: null,
            subTitle:
              "Logging pipeline via Fluentd/Logstash to Elastic or centralized SIEM",
            svg: (
              <svg
                width="87"
                height="41"
          ...
          {
            title: null,
            subTitle: "Scheduled scaling policies for workloads",
            svg: (
              <svg
                width="61"
                height="55"
      ...
      <Agility
        data={{
          leftSideContent: {
            ...
            subTitle: "What Calsoft environments enable",
            description:
              "Our OpenStack deployments have helped customers achieve:",
          },
          rightSideContent: [
            {
              title: "99.95%",
              subTitle:
                "availability via HA clustering and API endpoint resiliency",
            },
            {
              title: "2x faster",
              subTitle:
          ...
          tableContent: [
            {
              ...
              calsoft: " Yes",
              vendor: "One-size-fits-all",
            },
            {
              name: "Multi-node HA deployment",
              calsoft: " Proven Topologies",
              vendor: "Risk of SPOF",
            },
            {
              name: "Policy-as-Code & Security",
              calsoft: " Open Observability Stack",
              vendor: "Optional or Fragmented",
            },
            {
              name: "RBAC & Tenant Governance",
              calsoft: "Aligned with Compliance",
              vendor: "Ad hoc Policies",
            },
            {
              name: "Automation for scaling and patching",
              calsoft: "Built-in from Day 1",
              vendor: "Day-2 Left to Ops Teams",
            },
          ],
        }}
      />
      <HowToStart
        headerContent={{
          title1: "How to Start",
          description: "Production-ready OpenStack in 5 steps",
        }}
        data={{
          Assess: "Current infra, use case, team skills, and growth goals",
          Design:
            "Reference architecture with components, HA, storage, and networks",
          Implement:
            "Automate installation, configure services, validate stack health",
          Integrate:
            "Hook up monitoring, CI/CD pipelines, access control, and logs",
          Enable:
            "Deliver runbooks, training, scaling playbooks, and Day-2 support",
        }}
      />
      <ContactSecDataAi
        lightContent={
