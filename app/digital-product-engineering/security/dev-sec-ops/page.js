...
export default function Page() {
  ...
  return (
    <>
      <HeroSection
        title="Secure by Design. Not by Delay."
        description="Embed security into your pipeline-code safely, deploy faster."
      ...
      <IntelligentPlanning
        heading="Security integrated across your DevOps lifecycle"
        description="Calsoft enables:"
        data={[
          {
            title: "Static & dynamic code analysis (SAST/DAST) in real-time",
            subTitle: null,
            curved: true,
          },
          {
            title: "Container image scanning & supply chain validation",
            subTitle: null,
            curved: true,
          },
          {
            title: "IaC security checks for Terraform, Helm, Ansible, etc.",
            subTitle: null,
            curved: true,
          },
          {
            title: "Secrets and key leakage detection in repos & configs",
            subTitle: null,
            curved: true,
          },
          {
            title: "Policy-as-code enforcement for K8s, cloud, and CI/CD",
            subTitle: null,
            curved: true,
          },
          {
            title: "Open source license and vulnerability scanning (SCA)",
            subTitle: null,
            curved: true,
          },
          {
            title: "Runtime protection integration with WAFs & eBPF tools",
            subTitle: null,
            curved: true,
          },
          {
            title: "Automated compliance evidence collection (SOC2, PCI, HIPAA)",
            subTitle: null,
            curved: true,
          },
        ]}
      ...
      <RealWorldImpact
        ...
        title="Built to fit your existing toolchain"
        desc="We integrate with:"
        cardData={[
          {
            title: "CI/CD",
            desc: "Jenkins, GitHub Actions, GitLab CI, CircleCI, Azure DevOps",
          },
          {
            title: "Code Scanning",
            desc: "SonarQube, Checkmarx, Veracode, Fortify",
          },
          {
            title: "Containers & IaC",
            desc: "Prisma Cloud, Snyk, Anchore, Trivy, Checkov",
          },
          {
            title: "Secrets Detection",
            desc: "GitGuardian, AWS Secrets Manager, Doppler",
          },
          {
          ...
          },
          {
            ...
            desc: "Falco, Aqua, Sysdig, OpenTelemetry",
          },
          {
            title: "Dashboards",
            desc: "Grafana, ELK Stack, Splunk",
          },
        ]}
        bottomContent={null}
      />
      <div className="container">
        <BookMeeting
          title="Integrate security 3x earlier via DevSecOps."
          img={img}
        />
      </div>
      <UseCases
        ...
        data={[
          {
            title: "80% reduction",
            subTitle: "in security debt during pre-prod stages",
            svg: (
              <svg
                width="54"
                height="64"
          ...
          {
            title: "<2-hour SLA",
            subTitle: "for new code security validations",
            svg: (
              <svg
                width="64"
                height="62"
          ...
          {
            title: "Up to 60%",
            subTitle: "fewer post-deployment vulnerabilities",
            svg: (
              <svg
                width="59"
                height="59"
          ...
          },
          {
            ...
            subTitle: "evidence mapped to release artifacts",
            svg: (
              <svg
                width="87"
                height="41"
          ...
          {
            title: "Culture shift",
            subTitle: "—developers own security with minimal friction",
            svg: (
              <svg
                width="61"
                height="55"
      ...
      <WhyCalsoft
        ...
        title="How our DevSecOps model compares"
        data={{
          tableHeadings: [
            "Capability",
            "Calsoft DevSecOps",
          ...
          tableContent: [
            {
              name: "Security integrated with CI/CD",
              calsoft: "Embedded at each stage",
              vendor: "After-thought scans",
            },
            {
              name: "IaC and container checks",
              calsoft: "Included",
              vendor: "Often skipped",
            },
            {
              name: "Developer-first enablement",
              calsoft: "Contextual feedback loops",
              vendor: "Top-down only",
            },
            {
              name: "Policy-as-code governance",
              calsoft: "Automated and versioned",
              vendor: "Manual policy audits",
            },
            {
              name: "Compliance visibility",
              calsoft: "Continuous audit trails",
              vendor: " Point-in-time reports",
            },
          ],
        }}
      />
        ...
        guessworkData={[
          {
            heading: "Assess",
            title: null,
            desc: "Pipeline health, security gaps, developer pain points",
          },
          {
            heading: "Map",
            title: null,
            desc: "Toolchain, IaC use, code volume, compliance scope",
          },
          {
            heading: "Design",
            title: null,
            desc: "Security gates, SAST/DAST flows, policy packs",
          },
          {
            heading: "Implement",
            title: null,
            desc: "CI/CD hooks, scanners, secrets checks, dashboards",
          },
          {
            heading: "Enable",
            title: null,
            desc: "Train dev teams, integrate with Jira/Git, create playbooks",
          },
        ]}
        Component={Guesswork}
        output="Output: DevSecOps Framework + Vulnerability Matrix + Policy Templates + Enablement Guide"
      />
      <ContactSecDataAi
        lightContent={
