...
export default function Page() {
  ...
  return (
    <>
      <HeroSection
        title="Identity is the New Security Perimeter."
        description="Centralized IAM for secure, compliant access across cloud, SaaS, and on-prem."
      ...
      <IntelligentPlanning
        heading="End-to-end IAM Enablement"
        description="Calsoft implements IAM with:"
        buttonText="Request POC"
        data={[
          {
            title: "Identity federation and SSO ",
            subTitle: "across cloud, SaaS, and legacy apps",
            curved: true,
          },
          {
          ...
          {
            title: "Multi-factor authentication (MFA) and adaptive access",
            subTitle: null,
            curved: true,
          },
          {
            title: "Integration with Zero Trust, SASE, and CIEM frameworks",
            subTitle: null,
            curved: true,
          },
          {
            title: "Audit logging, anomaly detection, and identity analytics",
            subTitle: null,
            curved: true,
          },
          {
            title: "Support for workforce, customer, and third-party identities",
            subTitle: null,
            curved: true,
          },
        ]}
      ...
      <RealWorldImpact
        ...
        title="Works with your tools — not against them"
        desc="Our IAM enablement supports:"
        cardData={[
          {
            title: "Clouds",
            desc: "AWS IAM, Azure AD, GCP IAM",
          },
          {
            title: "SSO/IDaaS",
            desc: "Okta, Ping Identity, ForgeRock, Auth0",
          },
          {
            title: "PAM",
            desc: "CyberArk, HashiCorp Vault, BeyondTrust",
          },
          {
          ...
          },
          {
            ...
            desc: "Salesforce, ServiceNow, Office365, Zoom",
          },
          {
            title: "Security Stack",
            desc: "SIEM, XDR, CASB, ZTNA, CIEM",
          },
        ]}
        bottomContent={null}
      />
      <div className="container">
        <BookMeeting
          title="Secure identities across enterprise with IAM."
          img={img}
        />
      </div>
      <UseCases
        title="Real-World Impact"
        heading="IAM that improves security, productivity, and compliance"
        description=""
        ...
        data={[
          {
            title: "70% faster employee",
            subTitle: "onboarding/offboarding",
            svg: (
              <svg
                width="54"
                height="64"
          ...
          {
            title: "100% audit-ready logs ",
            subTitle: "across all identity interactions",
            svg: (
              <svg
                width="64"
                height="62"
          ...
          {
            title: "2x reduction in",
            subTitle: "access violations after policy enforcement",
            svg: (
              <svg
                width="59"
                height="59"
          ...
          {
            title: "Improved SLA",
            subTitle: "for app access provisioning from days to hours",
            svg: (
              <svg
                width="87"
                height="41"
          ...
          {
            title: "Lower breach probability",
            subTitle: "with continuous access monitoring",
            svg: (
              <svg
                width="61"
                height="55"
      ...
      <WhyCalsoft
        ...
        title="Why our IAM solutions outperform legacy frameworks"
        data={{
          tableHeadings: [
            "Feature",
            "Calsoft IAM Framework",
            "Conventional IAM Models",
          ],
          tableContent: [
            {
              name: "Unified identity governance",
              calsoft: "Cross-cloud and on-prem",
              vendor: "Fragmented across platforms",
            },
            {
              name: "Adaptive access controls",
              calsoft: "Role + context + risk scoring",
              vendor: "Static roles only",
            },
            {
              name: "Automated provisioning & audit",
              calsoft: "Prebuilt workflows",
              vendor: "Manual/partial",
            },
            {
              name: "PAM & MFA integrations",
              calsoft: "Best-in-class tools",
              vendor: "Often siloed",
            },
            {
              name: "Zero Trust & SASE aligned",
              calsoft: "Built-in",
              vendor: "Retrofit needed",
            },
          ],
        }}
      />
      <FirstStep
        headerContent={{
          ...
          title2: null,
          description:
            "Modernize your identity control with a guided rollout",
        }}
        guessworkData={[
          {
            heading: "Assess",
            title: null,
            desc: "Identity sprawl, access bottlenecks, policy gaps",
          },
          {
            heading: "Map",
            title: null,
            desc: "Application, user, and device matrix across environments",
          },
          {
            heading: "Design",
            title: null,
            desc: "Unified IAM architecture with role, attribute, and policy layers",
          },
          {
            heading: "Deploy",
            title: null,
            desc: "Implement SSO, MFA, PAM, access controls, and workflows",
          },
          {
            heading: "Govern",
            title: null,
            desc: "Enable monitoring, logging, and compliance automation",
          },
        ]}
        Component={Guesswork}
        output="Output: IAM Blueprint + Risk Matrix + Policy Repository + Audit Toolkit"
      />
      <ContactSecDataAi
        lightContent={
