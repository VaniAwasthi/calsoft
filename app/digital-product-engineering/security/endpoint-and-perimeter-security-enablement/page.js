...
export default function Page() {
  ...
  return (
    <>
      <HeroSection
        title="Secure the Edge. Safeguard Every Endpoint."
        description="Securing devices, indentities and workloads with unified visibility and control."
        buttonText="Schedule Readiness Assessment"
        heroImage={Img}
        navItems={navItems}
      ...
      <IntelligentPlanning
        heading="Defense that travels with your users and workloads"
        description="Calsoft’s Endpoint & Perimeter Security Services cover:"
        data={[
          {
            title: "Endpoint Detection & Response (EDR)",
            subTitle: "and Extended Detection & Response (XDR)",
            curved: true,
          },
          {
            title: "Policy-based access control",
            subTitle: "using Zero Trust principles",
            curved: true,
          },
          {
            title: "Agentless edge device discovery",
            subTitle: "and security posture analysis",
            curved: true,
          },
          {
            title: "Real-time threat detection",
            subTitle: "using AI/ML-based engines",
            curved: true,
          },
          {
            title: "Micro-segmentation across virtual, containerized, and physical endpoints",
            subTitle: null,
            curved: true,
          },
          {
            title: "Secure boot, device attestation, and identity binding",
            subTitle: null,
            curved: true,
          },
          {
            title: "Integration with IAM, SIEM, SOAR, and SASE frameworks",
            subTitle: null,
            curved: true,
          },
          {
            title: "Full kill-chain visibility with actionable analytics",
            subTitle: null,
            curved: true,
          },
        ]}
      ...
      <RealWorldImpact
        ...
        title="Not another tool — a strategic integration layer"
        desc="We work across your stack:"
        cardData={[
          {
            title: "Endpoint Platforms",
            desc: "Microsoft Defender, CrowdStrike, SentinelOne, Tanium",
          },
          {
            title: "Edge Security",
            desc: "Zscaler, Netskope, Palo Alto Prisma Access, Fortinet",
          },
          {
            title: "IAM/SIEM",
            desc: "Okta, Ping, Azure AD, Splunk, QRadar",
          },
          {
            title: "SASE Frameworks",
            desc: "Cisco Umbrella, Cloudflare Zero Trust, Versa",
          },
          {
            title: "Automation",
            desc: "SOAR, XDR workflows, risk-based policy enforcement",
          },
        ]}
        bottomContent={null}
      />
      <div className="container">
        <BookMeeting
          title="Mitigate 85% threats via zero-trust perimeters."
          img={img}
        />
      </div>
      <UseCases
        title="Real-World Impact"
        heading="Security that scales as fast as your business"
        description=""
        bottomText={{
          text: null,
          bText: null,
        ...
        data={[
          {
            title: "50% reduction",
            subTitle: "in endpoint breach incidents within 6 months",
            svg: (
              <svg
                width="54"
                height="64"
          ...
          {
            title: "2x faster",
            subTitle: "threat response time via automated XDR triggers",
            svg: (
              <svg
                width="64"
                height="62"
          ...
          {
            title: "Up to 60%",
            subTitle: "improvement in policy enforcement across hybrid edge",
            svg: (
              <svg
                width="59"
                height="59"
          ...
          {
            title: "Compliance-ready device telemetry",
            subTitle: "for HIPAA, GDPR, PCI-DSS",
            svg: (
              <svg
                width="87"
                height="41"
          ...
          },
          {
            ...
            subTitle: "with adaptive threat intel",
            svg: (
              <svg
                width="61"
                height="55"
      ...
      <WhyCalsoft
        ...
        title="How our approach is different"
        data={{
          tableHeadings: [
            "Capability",
            "Calsoft Enablement",
            "Conventional Endpoint Tools",
          ],
          tableContent: [
            {
              name: "Unified visibility (edge to cloud)",
              calsoft: "Full device + identity map",
              vendor: "Siloed device view",
            },
            {
              name: "Zero Trust Network Access (ZTNA)",
              calsoft: "Integrated",
              vendor: "Often bolt-on",
            },
            {
              name: "Agentless discovery",
              calsoft: "Yes",
              vendor: "Requires manual inventory",
            },
            {
              name: "Real-time policy enforcement",
              calsoft: "API + behavioral triggers",
              vendor: "Static ACLs only",
            },
            {
              name: "SIEM/XDR/SASE orchestration",
              calsoft: "Pre-integrated workflows",
              vendor: "Needs custom scripting",
            },
          ],
        }}
      />
      <FirstStep
        headerContent={{
          ...
          title2: null,
          description:
            "Secure your network—starting from the edge",
        }}
        guessworkData={[
          {
            heading: "Assess",
            title: null,
            desc: "Current endpoint and edge inventory, risks, and access posture",
          },
          {
            heading: "Map",
            title: null,
            desc: "Define device trust levels, location context, user roles",
          },
          {
            heading: "Design",
            title: null,
            desc: "Build policies for ZTNA, EDR/XDR, segmentation",
          },
          {
            heading: "Implement",
            title: null,
            desc: "Deploy agents, gateways, monitoring layers",
          },
          {
            heading: "Automate",
            title: null,
            desc: "Configure alerts, playbooks, and kill-switch policies",
          },
        ]}
        Component={Guesswork}
        output="Output: Zero Trust Security Blueprint + Endpoint Risk Matrix + Policy Templates"
      />
      <ContactSecDataAi
        lightContent={
