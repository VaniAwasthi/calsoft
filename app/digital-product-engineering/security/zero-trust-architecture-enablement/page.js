...
import Img from "@/app/assets/DigitalEngineering/storage-net/Storage_Banner_2.webp";
import SecurityWhereItFits from "@/app/component/security-services/SecurityWhereItFits"
import IdentityWhyItMatters from "@/app/component/security-services/IdentityWhyItMatter";
...
export default function Page() {
  ...
  return (
    <>
      <HeroSection
        title="Assume Breach. Always Verify. Never Trust."
        description="Zero Trust that secures users, data, and workloads through continuous verification and access control."
      ...
      <IdentityWhyItMatters />

      <IntelligentPlanning
        heading="Zero Trust isn’t a tool. It’s a framework."
        description="Calsoft’s Zero Trust Enablement spans:"
        data={[
          {
            title: "User & device trust verification before every access",
            subTitle: null,
            curved: true,
          },
          {
            title: "Micro-segmentation of network, workloads, and apps",
            subTitle: null,
            curved: true,
          },
          {
            title: "Least-privilege access policies with role and behavior context",
            subTitle: null,
            curved: true,
          },
          {
            title: "Continuous access evaluation with risk scoring and re-authentication",
            subTitle: null,
            curved: true,
          },
          {
            title: "Identity Federation + MFA + SSO integrations",
            subTitle: null,
            curved: true,
          },
          {
            title: "Policy-as-code for infrastructure access",
            subTitle: null,
            curved: true,
          },
          {
            title: "Integration with SASE, ZTNA, SIEM, and XDR frameworks",
            subTitle: null,
            curved: true,
          },
          {
            title: "Real-time posture assessment and anomaly detection",
            subTitle: null,
            curved: true,
          },
        ]}
      ...
      <RealWorldImpact
        ...
        title="Plug Zero Trust into your current stack"
        desc="We orchestrate ZTA across:"
        cardData={[
          {
            title: "Identity Providers",
            desc: "Okta, Azure AD, Ping, Auth0",
          },
          {
            title: "Access Controls",
            desc: "Zscaler ZPA, Netskope, Cloudflare Zero Trust",
          },
          {
            title: "Network & Micro-Segmentation",
            desc: "Illumio, Cisco Tetration, Palo Alto Prisma",
          },
          {
            title: "SASE",
            desc: "Fortinet, Versa, Palo Alto, Cisco Umbrella",
          },
          {
            title: "SIEM/XDR",
            desc: "Splunk, IBM QRadar, Microsoft Sentinel",
          },
          {
            title: "PAM & Endpoint",
            desc: "CyberArk, BeyondTrust, CrowdStrike, Tanium",
          },
          {
            title: "Policy-as-Code",
            desc: "OPA/Gatekeeper, Kyverno, HashiCorp Sentinel",
          },
        ]}
        bottomContent={null}
      />
      <div className="container">
        <BookMeeting
          title="Achieve 100% policy enforcement with zero trust."
          img={img}
        />
      </div>
      <UseCases
        title="Real-World Impact"
        heading="Security that adapts. Access that makes sense."
        description=""
        bottomText={{
          text: null,
          bText: null,
        ...
        data={[
          {
            title: "60% reduction",
            subTitle: "in lateral movement risk through micro-segmentation",
            svg: (
              <svg
                width="54"
                height="64"
          ...
          {
            title: "90% of access",
            subTitle: "requests verified in real-time with risk scoring",
            svg: (
              <svg
                width="64"
                height="62"
          ...
          {
            title: "Up to 45%",
            subTitle: "improvement in audit readiness via continuous access logs",
            svg: (
              <svg
                width="59"
                height="59"
          ...
          {
            title: "Reduced mean time",
            subTitle: "to respond (MTTR) by 50%",
            svg: (
              <svg
                width="87"
                height="41"
          ...
          },
          {
            ...
            subTitle: "progression from siloed to integrated in under 6 months",
            svg: (
              <svg
                width="61"
                height="55"
      ...
      <WhyCalsoft
        ...
        title="Our Zero Trust delivery is engineered for impact"
        data={{
          tableHeadings: [
            "Capability",
            "Calsoft ZTA Enablement",
            "Typical Security Frameworks",
          ],
          tableContent: [
            {
              name: "Continuous policy evaluation",
              calsoft: "Real-time, context-aware",
              vendor: "Static rulesets",
            },
            {
              name: "Policy-as-code architecture",
              calsoft: "GitOps + audit ready",
              vendor: "Manual configs",
            },
            {
              name: "Multi-layer integration (cloud + on-prem)",
              calsoft: "Unified delivery",
              vendor: "Fragmented",
            },
            {
              name: "Micro-segmentation enablement",
              calsoft: "Host, app, data-level",
              vendor: "Network-only",
            },
            {
              name: "Access analytics + risk scoring",
              calsoft: "Behavior-based enforcement",
              vendor: "Role-only logic",
            },
          ],
        }}
      />
      <FirstStep
        headerContent={{
          ...
          title2: null,
          description:
            "Make Zero Trust practical, not theoretical",
        }}
        guessworkData={[
          {
            heading: "Assess",
            title: null,
            desc: "Identity, access controls, network structure, and risk zones",
          },
          {
            heading: "Map",
            title: null,
            desc: "Data flow, user journeys, privileged paths, trust boundaries",
          },
          {
            heading: "Design",
            title: null,
            desc: "ZTA blueprint with components: ZTNA, MFA, policies, logging",
          },
          {
            heading: "Implement",
            title: null,
            desc: "Federated identity, segmentation, SASE, CIEM, analytics",
          },
          {
            heading: "Monitor",
            title: null,
            desc: "Enable continuous policy evaluation and breach simulations",
          },
        ]}
        Component={Guesswork}
        output="Output: Zero Trust Maturity Scorecard + Access Policy Matrix + Implementation Roadmap"
      />
      <ContactSecDataAi
        lightContent={
