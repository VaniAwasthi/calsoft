...
export default function Page() {
  ...
  return (
    <>
      <HeroSection
        title="Always On. Always Recoverable."
        description="Ensuring uptime with backup automation and disaster recovery across cloud and edge."
      ...
      <IntelligentPlanning
        heading="Backup, recovery, and resilience—built in, not bolted on"
        description="Calsoft's service continuity offering includes:"
        data={[
          {
            title: "Automated, policy-driven backup pipelines (hourly, daily, custom)",
            subTitle: null,
            curved: true,
          },
          {
            title: "Real-time replication across availability zones",
            subTitle: null,
            curved: true,
          },
          {
            title: "Tiered backup to hot, warm, and cold storage (cloud-native)",
            subTitle: null,
            curved: true,
          },
          {
            title: "Immutable backups with ransomware protection",
            subTitle: null,
            curved: true,
          },
          {
            title: "Disaster Recovery (DR) orchestration with RTO/RPO guarantees",
            subTitle: null,
            curved: true,
          },
          {
            title: "Backup validation, DR drills, and failover simulations",
            subTitle: null,
            curved: true,
          },
          {
            title: "Cross-cloud workload mobility for continuity assurance",
            subTitle: null,
            curved: true,
          },
          {
            title: "Compliance-aligned backup retention and encryption policies",
            subTitle: null,
            curved: true,
          },
        ]}
      ...
      <RealWorldImpact
        ...
        title="Integrates across infrastructure layers and ecosystems"
        desc="Supports:"
        cardData={[
          {
            title: "Cloud platforms",
            desc: "AWS (Backup, DRS), Azure (Site Recovery), GCP",
          },
          {
            title: "Storage solutions",
            desc: "NetApp, Dell EMC, Cohesity, Veeam, Commvault",
          },
          {
            title: "Containerized environments",
            desc: "Kasten, Portworx, Velero",
          },
          {
            title: "Hypervisors",
            desc: "VMware, Hyper-V, KVM",
          },
          {
            title: "Workload types",
            desc: "DB (SQL, Mongo, PostgreSQL), VM, Bare Metal, SaaS (M365)",
          },
          {
            title: "Compliance",
            desc: "ISO 27001, HIPAA, RBI, SOX, GDPR, FedRAMP",
          },
        ]}
        bottomContent={null}
      />
      <div className="container">
        <BookMeeting
          title="Ensure 99.9% data protection with backups."
          img={img}
        />
      </div>
      <UseCases
        title="Real-World Impact"
        heading="Less downtime. More resilience. Lower risk."
        description=""
        bottomText={{
          text: null,
          bText: null,
        ...
        data={[
          {
            title: "Up to 95%",
            subTitle: "reduction in manual recovery time",
            svg: (
              <svg
                width="54"
                height="64"
          ...
          {
            title: "<15 minutes",
            subTitle: "RTO/RPO for business-critical apps",
            svg: (
              <svg
                width="64"
                height="62"
          ...
          {
            title: "3x increase",
            subTitle: "in audit pass rate with consistent backup logs",
            svg: (
              <svg
                width="59"
                height="59"
          ...
          {
            title: "Near-zero data",
            subTitle: "loss via cross-region sync and versioning",
            svg: (
              <svg
                width="87"
                height="41"
          ...
          },
          {
            ...
            subTitle: "SLAs (99.95%+) via proactive orchestration",
            svg: (
              <svg
                width="61"
                height="55"
      ...
      <WhyCalsoft
        ...
        title="Why our continuity solutions outperform ad-hoc approaches"
        data={{
          tableHeadings: [
            "Feature",
            "Calsoft BCDR Enablement",
            "Traditional Models",
          ],
          tableContent: [
            {
              name: "Multi-platform backup automation",
              calsoft: "Unified pipelines",
              vendor: "Disconnected tools",
            },
            {
              name: "DR drills with failover validation",
              calsoft: "Scheduled + simulated",
              vendor: "Manual or skipped",
            },
            {
              name: "Immutable, ransomware-proof storage",
              calsoft: "Built-in",
              vendor: "Often missing",
            },
            {
              name: "Policy-as-code for backups/retention",
              calsoft: "Fully auditable",
              vendor: "Manual spreadsheets",
            },
            {
              name: "Cross-region, cloud-native sync",
              calsoft: "Real-time",
              vendor: "Delayed/complex",
            },
          ],
        }}
      />
      <FirstStep
        headerContent={{
          ...
          title2: null,
          description:
            "Resilience without the complexity",
        }}
        guessworkData={[
          {
            heading: "Assess",
            title: null,
            desc: "Current backup gaps, failover paths, RTO/RPO needs",
          },
          {
            heading: "Map",
            title: null,
            desc: "Application criticality and storage tiering strategy",
          },
          {
            heading: "Design",
            title: null,
          ...
          },
          {
            heading: "Implement",
            title: null,
            desc: "Automation, monitoring, and DR validation tooling",
          },
          {
            heading: "Simulate",
            title: null,
            desc: "Run failover drills, restore testing, and compliance reporting",
          },
        ]}
        Component={Guesswork}
        output="Output: Backup Blueprint + Resilience Scorecard + Compliance Mapping Matrix"
      />
      <ContactSecDataAi
        lightContent={
