...
export const SustenanceChallenge= () => {
    const challengesData = [
        {
            ...
            description: "Uncoordinated updates can introduce instability or downtime post-deployment",
            solution:
    ...
    return (
        <ChallengeToSolution
            ...
            blackTitle="Ensure value-inducing support while while
        ...
        <>
            <InfraSection
                ...
                whatWeDo={[
                    ...
                    "Add rollback paths for fallback",
                ]}
                businessImpact={[
