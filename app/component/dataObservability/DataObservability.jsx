...
export const DataSolutionSec = () => {
    const data = [
      ...
      challenge:
        ...
        },
        {
            ...
            challenge:
                "Finding anomalies too late in streaming data pipelines?",
            solution:
        ...
        },
        {
            ...
            challenge:
                "Reacting only after data issues impact downstream analytics?",
            solution:
    ...
    return (
        <>
            <ChallengeSolutionComp
                data={data}
                BlackHeading="Monitor, predict, and fortify data
