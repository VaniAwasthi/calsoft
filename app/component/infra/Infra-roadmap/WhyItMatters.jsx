            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6 text-black text-lg leading-relaxed">
                <p>
                  ...
                  on-prem, cloud-native, and edge setups running in silos. This
                  complexity leads to:
                </p>
                <p>
                  Calsoft's Roadmap Approach begins with mapping your existing
                  ecosystem, identifying technical and business bottlenecks, and
                  creating a data-backed transformation baseline.
                </p>
              </div>
            </div>
            <div
