  ...
  const caseStudyDataArray = [
    {
      ...
      description: ["<strong>Insight:</strong> First project insights.", "Detail explanation of achievements."],
      buttonText: "Download PDF",
      pdfLink: "/pdfs/case1.pdf",
      stats: [
        { count: "25%", text: "Increased Engagement" },
        { count: "50k+", text: "New Users" },
      ],
    },
    {
      id: 2,
      title: "Case Study Two",
      description: ["<strong>Insight:</strong> Second project insights.", "Another detailed explanation."],
      buttonText: "View PDF",
      pdfLink: "/pdfs/case2.pdf",
      stats: [
        { count: "60%", text: "ROI Growth" },
        { count: "80k+", text: "Active Users" },
      ],
    },
    {
      id: 3,
      title: "Case Study Three",
      description: ["<strong>Insight:</strong> Third project insights.", "Further elaboration."],
      buttonText: "Read PDF",
      pdfLink: "/pdfs/case3.pdf",
      stats: [
        { count: "90%", text: "Conversion Rate" },
        { count: "100k+", text: "Monthly Visitors" },
      ],
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-20">
        ...
        <div className="pt-8 gradient-border">
          ...
          <motion.h2
            ...
            className="text-3xl md:text-[36px] font-semibold bg-[linear-gradient(to_right,#2E3092_18%,#ED1C24_33%)] bg-clip-text text-transparent"  dangerouslySetInnerHTML={{__html: heading}} >
