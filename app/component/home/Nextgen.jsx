      ...
      <div className="w-full bg-[#021553] rounded-b-xl min-h-screen">
        <div className="mx-auto px-4 xl:px-20" id="customers">
          ...
          <div className="flex gap-6 md:gap-6 items-center mb-6 py-5">
            <div className="rounded-full bg-[#ffff] w-8 h-8 p-2 flex items-center justify-center">
              <Image src={icon} alt="icon" width={16} height={16} />
            </div>
            <p className="font-light text-xl text-white">Industry</p>
          </div>
          <div className="container mx-auto px-4 xl:px-20">
            ...
            <motion.div
              ...
              animate={{ x: 2, opacity: 1 }}
              transition={{ duration: 0.5, delay: 0.2 }}
              className="flex lg:flex-row flex-row mt-[4rem] mb-[2rem]"
            >
              {/* Image */}
              {activeIndustry && (
                <motion.div
