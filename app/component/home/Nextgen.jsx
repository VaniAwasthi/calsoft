          ...
          <div className="flex overflow-x-auto md:overflow-visible gap-6 px-2 pb-2 scroll-smooth">
            {activeIndustry.iconData.map((card, index) => (
              <motion.div
                ...
                viewport={{ once: false, amount: 0.3 }}
                className="card-hover flex-shrink-0 min-w-[70px] min-h-[60px] md:w-[90px] md:h-[80px] xl:w-[100px] xl:h-[90px] transition-transform duration-500 hover:scale-125 perspective cursor-pointer"
              >
