...
export const Stages = () => {
    const stepsData = [
        ...
        {
            title: "Assure & secure",
            description: "Ensure performance, security, and release readiness continuously.",
        },
        {
            title: "Support & evolve",
            description: "Maintain uptime, release updates, and optimize post-launch.",
        },
    ];
    return (
        <>
    ...
    const data = [
        {
            ...
            description: "Agile, full-cycle engineering with DevOps, quality, and architecture alignment.",
        },
        {
            image: image2,

            title: "CX engineering",
            description: "Design modern, responsive, and user-centric interfaces across web and mobile",
        },
        {
            image: image3,

            title: "Cloud services",
            description: "Cloud-native engineering, deployment pipelines, and multi-cloud readiness.",
        },
    ]
    return (
        <>
    ...
    const data = [
        {
            ...
            description: "Re-architect legacy apps and extend into digital ecosystems with partner-ready interfaces.",
        },
        {
            image: image5,

            title: "Storage & networking",
            description: "Agile, scalable infrastructure design with SDS, SDN, HCI, and edge integration.",
        },
        {
            image: image6,

            title: "Virtualization",
            description: "Manage VMs, containers, and orchestration across hybrid and multi-cloud setups.",
        },
    ]
    return (
        <>
            <Imagethree heading="Ecosystem and infrastructure alignment" data={data} />
    ...
    const data = [
        {
            ...
            description: "Automated functional and non-functional testing integrated into CI/CD pipelines.",
        },
        {
            image: image8,

            title: "Security",
            description: "DevSecOps, Zero Trust, IAM, and business continuity for secure engineering at scale.",
        },
        {
            image: image9,

            title: "Sustenance & support",
            description: "Release planning, uptime monitoring, documentation, and tiered support frameworks.",
        },
    ]
    return (
        <>
                ...
                <div className='container mx-auto px-4 md:px-16'>
                    <div className="flex md:flex-nowrap flex-wrap gap-6 justify-between">
                        <div className="w-full md:w-2/3">
                            ...
                            <h2 className="text-xl md:text-[38px] font-semibold mb-0 md:mb-10 text-[#2E3092] ">engineering services</h2>
                        </div>
                    ...
                    <div className="w-full mt-8 md:mt-0">
                        <Image src={deep} alt="deep" width={800} height={400} className="w-full h-full" />
                    </div>
                </div>
            </section>
