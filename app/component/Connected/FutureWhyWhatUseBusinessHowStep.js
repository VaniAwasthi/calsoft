...
import BackgroundImage from "../../assets/DigitalEngineering/connected/banner.webp";
    ...
    const useCasesData = {
        ...
        cards: [
            ...
            },
            {
                ...
                description: "Connect ERP, payment gateway, customer support, and analytics via APIs",
            },
            {
                title: "IoT-Edge Synchronization",
                description: "Real-time data flow between field devices and cloud AI/ML systems",
            },
        ],
    };
    return (
...
export const Business = () => {
    const businessValueData = {
        ...
        description:
            "Here’s what a connected ecosystem delivers:",
        ...
        valueItems: [
            ...
            {
                title: "90%+",
                subtitle: "data availability for analytics, dashboards, and decision engines",
            },
            {
                title: "$250K+",
                subtitle: "annual savings from reducing redundant apps & manual handovers",
            },
            {
                title: "Unified",
                subtitle: "governance across systems, ensuring compliance and traceability",
            },
        ],
    };
    return (
