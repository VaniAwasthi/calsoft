  ...
  return (
    <div className="w-full h-full flex justify-center items-center relative">
      ...
      <motion.div
        ...
        className="w-44 h-44 bg-blue-800 absolute top-6 rotate-45 rounded-lg text-white"
      >
      ...
      <motion.div
        ...
        transition={{ duration: 0.8, delay: 0.4 }}
        viewport={{ once: false, amount: 0.3 }}
        className="w-44 h-44 bg-blue-800 absolute bottom-6 left-[3.65rem] rotate-45 rounded-lg text-white"
      >
        <div className="w-full h-full -rotate-45 text-center space-y-1.5 flex flex-col justify-center items-center p-5">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8, delay: 0.4 }}
        viewport={{ once: false, amount: 0.3 }}
        className="w-44 h-44 bg-blue-800 absolute bottom-6 right-[3.6rem] rotate-45 rounded-lg text-white"
      >
