...
export const Do = ({ offerings, timeline, highlights, heading, subtitle, desc, ButtonImage, buttonText, link, secId }) => {
    return (
        <>
            <section className="bg-[#F4F4F4] pb-8 py-6 md:py-10 md:pb-20 mt-8" id={secId}>
                            ...
                            <>
                                <div className="flex md:flex-nowrap flex-wrap md:gap-10 gap-6">
                                    ...
                                    >
                                        {highlights.length > 0 && (
                                            <div
                                                className={`grid md:gap-6 gap-4 mt-6 ${timeline ? `md:grid-cols-${highlights.length}` : `md:grid-cols-${highlights.length}`
                                                    }`}
                                            >
                                                {highlights.map((highlight, idx) => (
                                                    <div key={idx} className="flex md:gap-6 gap-4 items-center">
...
export const Cases = ({ image, heading, subheading, description, buttonText, link, cards, ButtonImage, secId, direction }) => {
    return (
        <>
            <section className={`!py-10 md:!py-8 md:!pt-16 !pb-6 px-4 container mx-auto  md:px-16 use_Sec ${direction ? "change_direction" : ""}`} id={secId}>
                        ...
                        {cards.map((item, idx) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <h4 className="font-semibold text-[12px] md:text-2xl mb-2 group-hover:text-white">{item.title}</h4>
...
export const BusinessValue = ({
    ...
    return (
        <>
            <section
                className="relative container mx-auto  py-15  !px-0  md:!px-4 !my-10 md:!my-16" id={secId}  >
...
export const StartSection = ({ data, secId }) => {
    return (
        <>
            <section className="relative container mx-auto px-4 !mb-8 md:!mb-16" id={secId}>
        ...
        <>
            <section className='relative container mx-auto !px-0 md:px-4 md:!my-14 !my-8'>
                <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                    viewport={{ once: true }}
                    className="rounded-lg  overflow-hidden  bg-cover bg-center py-4 gradient_bg_border" style={{ backgroundImage: `url(${imageSrc.src})` }}
                >
                                ...
                                <div className="relative z-10 p-6 space-y-4 md:block flex flex-wrap">
                                    {stats.map((item, index) => (
                                        <div key={index} className='w-2/4 md:w-full'>
                                            <div className=''>
                                                <p className="text-[22px] md:text-[30px] font-normal text-black">{item.highlight}</p>
                                                <p className="text-sm md:text-base font-light w-[85%] text-black">{item.label}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
