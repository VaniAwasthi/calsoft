  ...
  return (
    <section className="px-6 py-12 md:px-16 lg:px-24">
      <div className="grid md:grid-cols-[1fr_2fr] gap-8 items-start">
        ...
        <div>
          {/* Heading */}
          <h2 className="text-2xl md:text-3xl font-semibold bg-[linear-gradient(to_right,#2E3092_10%,#ED1C24_28%)] bg-clip-text text-transparent">
            Why It Matters
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="rounded-md shadow overflow-hidden">
            <div className="bg-gradient-to-r from-[#2E3092] to-[#ED1C24] text-white px-4 py-3 font-semibold text-xl">
              What You Know:
            </div>
