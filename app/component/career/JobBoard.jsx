        ...
        {jobData.map((job, index) => (
          ...
          >
            ...
            <motion.div
              ...
              className="grid grid-cols-2 md:grid-cols-4 gap-5 py-5 px-8 sm:px-12 md:px-15 items-center cursor-pointer transition-colors duration-300"
            >
              <div
              ...
              <div className="flex justify-end">
                <motion.button
                  ...
                  className={`bg-transparent border-none text-xl cursor-pointer transition-colors duration-300 ${
                    expandedJob === job.id ? "text-white" : "text-gray-500"
                  }`}
                >
                  <svg
                    width="48"
            ...
            <AnimatePresence>
              {expandedJob === job.id && (
                <motion.div
                  ...
                  animate="expanded"
                  exit="collapsed"
                  className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] bg-[#2e3092] overflow-hidden"
                  style={{ borderRadius: "0px" }}
                >
                  {/* Content Container - Centered with max width */}
                  <div className="px-8 sm:px-12 md:px-15">
                    {/* Job Details */}
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-10 py-8">
                      <motion.div
            ...
            {expandedJob === job.id && index < jobData.length - 1 && (
              <div className="px-8 sm:px-12 md:px-15 mt-0.5">
                <div className="border-b border-gray-300"></div>
              </div>
            )}
          </motion.div>
