...
export const What = () => {
    ...
    const desc = "Future readiness isn’t about chasing trends—it’s about designing ecosystems that evolve. Calsoft blends architecture foresight, modularity, and automation to deliver tech that scales and adapts. Our Future-Readiness Offerings:"
...
export const Use = () => {
    const useCasesData = {
        ...
        description: "No matter your industry or transformation maturity, Calsoft enables future-readiness with real-world use cases.",
        buttonText: "Download One Pager",
        link: "#",
        cards: [
            {
                title: "Legacy to Composable Architecture",
                description: "Break monoliths into reusable services + automation hooks",

            },
            {
                title: "AI + Analytics Enablement",
                description: "Ready your platform for streaming data, LLMs, and real-time ops",

            },
            {
                title: "Compliance Driven Modernization",
                description: "Design infra and workflows that adapt to evolving data laws",
...
export const Business = () => {
    const businessValueData = {
        ...
        description:
            "What our customers gained by preparing today for tomorrow:",
        ...
        valueItems: [
            ...
            {
                title: "3X",
                subtitle: "faster onboarding of new capabilities (e.g., analytics, automation)",
            },
            {
                title: "Stronger",
...
export const Steps = () => {
    ...
    return (
        <>
            <SprintTimeline steps={steps} heading="10-Day Future-Readiness Sprint: Step-by-Step"
